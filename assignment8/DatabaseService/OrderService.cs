...
namespace OrderApp {
    ...
    public class OrderService
    {
        ...
        // Add a private instance of MyDatabase
        private MyDatabase myDatabase;

        public OrderService()
        {
            orders = new List<Order>();
            myDatabase = new MyDatabase(); // Initialize the MyDatabase instance
        }
        ...
        public void RemoveOrder(int orderId)
        {
            ...
            {
                orders.Remove(order);
                myDatabase.DeleteOrder(orderId);
            }
        }
        ...
        public void UpdateOrder(Order newOrder)
        {
            ...
            orders.Add(newOrder);
            myDatabase.UpdateOrder(newOrder);
        }
